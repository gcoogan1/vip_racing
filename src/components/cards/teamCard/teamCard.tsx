...
const TeamCard = ({ teamNumber, teamName, teamDrivers, teamImage }: TeamCardProps) => {
  ...
  return (
    <TeamCardContainer>
      ...
      <TeamInfo>
        ...
        <Button label="View Results" onClick={() => alert(`Viewing results for Team ${teamNumber}`)} variant="secondary" icon={<ArrowRight width={16} height={16} />} />
      </TeamInfo>
    </TeamCardContainer>
  )
}
